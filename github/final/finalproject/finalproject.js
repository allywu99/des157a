   ...
   pigBtn.addEventListener('mouseover', function(){
	...
	startGame.addEventListener('click', function () { 
		...
		nextBtn.addEventListener("click", function(){
			...
			const chef1Name = document.querySelector("#chef1Name").value;
			const chef2Name = document.querySelector("#chef2Name").value;
			console.log(chef1Name);
			console.log(chef2Name);
		})
...
const inputScreen = '<div class="hero"><h2>game of pig</h2><button id="playBtn"><i class="fas fa-music"></i></button><button id="pauseBtn"><i class="fas fa-pause"></i></button></div><img src="images/title.png" alt="Breakfast Edition title" id="header1" width="800" height="167"><h2 id="nameText">Enter Your Chef Names!</h2><div class="backNext"><div id="backBtn"><button id="tutorial" class="open" ><span class="shadow"></span><span class="edge"></span><span class="front text">QUIT</span></button></div><div id="nextBtn"><button id="tutorial" class="open"><span class="shadow"></span><span class="edge"></span><span class="front text">NEXT</span></button></div></div><div class="characters"><div class="charInput" id="chef1-1"><h1>Chef 1 Name</h1><input type="text" name="text" class="input" placeholder="Type here..." id="chef1Name"><img src="images/chef1.png" alt="Chef 1" id="femChef"></div><div class="charInput" id="chef2-1"><h1>Chef 2 Name</h1><input type="text" name="text" class="input" placeholder="Type here..." id="chef2Name"><img src="images/chef2.png" alt="Chef 1" id="maleChef"></div></div>';
